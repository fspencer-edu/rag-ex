...
# intialization chroma client with persistence
...
resp = client.chat.completions.create(
    ...
    messages=[
        ...
        {"role": "user", "content": "What is human life expectancy in the US"}
    ],
)

print(resp)

# Function - load documents from a directory
def load_documents_from_directory(directory_path):
    print("=== Loading Documents from Dir ===")
    documents = []
